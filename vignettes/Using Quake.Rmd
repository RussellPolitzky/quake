...
knitr::kable(clean_data[1:3, c(1:5, 48:49)])  # show 1st three rows and cols 1-5 and 48-49
```
...
```{r, echo=FALSE, results='asis'}
knitr::kable(head(clean_locations))  # show 1st three rows and cols 1-5 and 48-49
```
...
```{r, echo=FALSE, results='asis'}
knitr::kable(head(dt))  # show 1st three rows and cols 1-5 and 48-49
```
